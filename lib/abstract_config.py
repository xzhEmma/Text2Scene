...
parser.add_argument('--input_size',  nargs='+', type=int, default=[224, 224]) # 64 64 for COCO Layout, 224 224 for Abstract Scene
parser.add_argument('--input_vocab_size', type=int, default=2538) # 9908 for COCO Layout, 2538 for Abstract Scene
parser.add_argument('--output_cls_size',  type=int, default=61) # 80 + 3 = 83 for COCO Layout, 58 + 3 = 61 for Abstract Scene
parser.add_argument('--max_input_length', type=int, default=5) # 8 for COCO Layout, 5 for Abstract Scene
parser.add_argument('--n_conv_hidden',    type=int, default=1024)  # 256 for COCO Layout, 1024 for Abstract Scene 
parser.add_argument('--use_bn', type=str2bool, default=True) # false for COCO Layout, true for Abstract Scene 
parser.add_argument('--obj_loss_weight', type=float, default=5.0) # 8.0 for COCO Layout, 5.0 for Abstract Scene 

# arguments set as the same values for Abstract Scene and COCO Layout
##################################################################
# Data
##################################################################
...
parser.add_argument('--obj_embed',  type=int, default=1024)
...
# Misc
##################################################################
parser.add_argument('--exp_name', type=str, default='abstract_scene', help='experiment name for logging')
